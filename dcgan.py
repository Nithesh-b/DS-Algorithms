...
class DCGAN():
    ...
    def train(self, epochs, train_data, batch_size):
        ...
        ### Define real as an array with values 1 of shape (batch_size, 1)


        real = np.ones((batch_size, 1))


        ### Define fake as an array with values 0 of shape (batch_size, 1)
        ...
        self._image_helper.makegif("generated-images/")        
    ...
    def _build_generator_model(self):
        ...
        generator_input = Input(shape=(self.generator_input_dim,))
         ...
         ### Build generator sequence model using dense, reshape, upsampling, conv2d, activation (relu and tanh) and batchnormalization layers
    ...
    def _build_and_compile_discriminator_model(self, optimizer):
        ...
        ### Build discriminator sequence model using Conv2d, leakyrelu, dropout, conv2d, zeropadding, batchnormalization, flatten and Dense (with sigmoid activation) layers
    ...
    def _save_images(self, epoch):
        ...
        self._image_helper.save_image(generated, epoch, "generated-images/")
